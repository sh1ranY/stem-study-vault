...
面向理工科学生的 Codex skill。它会先了解你的目标和基础，再按知识之间的前置关系组织讲解、公式推导、示范和独立练习，并保留原始资料的来源位置。后续可以加入新课件、补充薄弱概念，或根据自己的做题反馈调整复习路线。
...
不用一次想清楚所有设置。Codex 会先查看资料，再询问真正缺少的信息；也可以要求直接完成资料范围明确的小课程。整门课程通常按批次推进，建设进度会保留下来，方便下一次继续。
